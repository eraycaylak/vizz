...
const MARKET_PRODUCTS = [
  ...
  {id:"m-klasik-cips",n:"Klasik Patates Cipsi",cat:"cips",price:42,unit:"107 g",emo:"🥔",img:"https://images.unsplash.com/photo-1566478989037-e924e5020a13?w=200&fit=crop&auto=format",stock:58,tag:"Çok Satan"},
  {id:"m-baharatli",n:"Baharatlı Cips",cat:"cips",price:42,unit:"107 g",emo:"🌶️",img:"https://images.unsplash.com/photo-1613919113640-25732ec5e61f?w=200&fit=crop&auto=format",stock:47},
  {id:"m-misir-cips",n:"Mısır Cipsi (Nacho)",cat:"cips",price:38,unit:"140 g",emo:"🌽",img:"https://images.unsplash.com/photo-1584311029193-41bb635b7194?w=200&fit=crop&auto=format",stock:33},
  {id:"m-cubuk-kraker",n:"Çubuk Kraker",cat:"cips",price:16,unit:"45 g",emo:"🥨",img:"https://images.unsplash.com/photo-1599321955726-e048426508ea?w=200&fit=crop&auto=format",stock:90},
  {id:"m-citir-misir",n:"Çıtır Mısır",cat:"cips",price:28,unit:"100 g",emo:"🍿",img:"https://images.unsplash.com/photo-1585647347384-2593bc35786b?w=200&fit=crop&auto=format",stock:25},
  {id:"m-soslu-cips",n:"Soslu Cips + Dip",cat:"cips",price:54,old:64,unit:"160 g",emo:"🥔",img:"https://images.unsplash.com/photo-1599599810694-f5b4b2f273db?w=200&fit=crop&auto=format",stock:12,tag:"Fırsat"},
  {id:"m-kakaolu-bisk",n:"Kakaolu Bisküvi",cat:"biskuvi",price:24,unit:"100 g",emo:"🍪",img:"https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=200&fit=crop&auto=format",stock:70},
  {id:"m-sandvic-bisk",n:"Sandviç Bisküvi",cat:"biskuvi",price:20,unit:"70 g",emo:"🍪",img:"https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=200&fit=crop&auto=format",stock:85,tag:"Çok Satan"},
  {id:"m-kremali-bisk",n:"Kremalı Bisküvi",cat:"biskuvi",price:22,unit:"90 g",emo:"🍪",img:"https://images.unsplash.com/photo-1590080874088-eec64895b423?w=200&fit=crop&auto=format",stock:48},
  {id:"m-tuzlu-kraker",n:"Tuzlu Kraker",cat:"biskuvi",price:14,unit:"75 g",emo:"🧂",img:"https://images.unsplash.com/photo-1599321955726-e048426508ea?w=200&fit=crop&auto=format",stock:110},
  {id:"m-yulaf-bar",n:"Yulaf Bar",cat:"biskuvi",price:26,unit:"40 g",emo:"🌾",img:"https://images.unsplash.com/photo-1622484211148-52261e479e0a?w=200&fit=crop&auto=format",stock:36,tag:"Yeni"},
  {id:"m-kola",n:"Kola (Kutu)",cat:"icecek",price:28,unit:"330 ml",emo:"🥤",img:"https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=200&fit=crop&auto=format",stock:140,tag:"Çok Satan"},
  {id:"m-kola-zero",n:"Kola Zero (Kutu)",cat:"icecek",price:28,unit:"330 ml",emo:"🥤",img:"https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=200&fit=crop&auto=format",stock:96},
  {id:"m-gazoz",n:"Limonlu Gazoz",cat:"icecek",price:22,unit:"250 ml",emo:"🍋",img:"https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=200&fit=crop&auto=format",stock:60},
  {id:"m-su",n:"Su",cat:"icecek",price:8,unit:"500 ml",emo:"💧",img:"https://images.unsplash.com/photo-1548839140-29a749e1bc4e?w=200&fit=crop&auto=format",stock:200},
  {id:"m-maden-suyu",n:"Maden Suyu",cat:"icecek",price:14,unit:"200 ml",emo:"🫧",img:"https://images.unsplash.com/photo-1615486171448-4fb65b822d5b?w=200&fit=crop&auto=format",stock:88},
  {id:"m-meyve-suyu",n:"Meyve Suyu (Şeftali)",cat:"icecek",price:24,unit:"200 ml",emo:"🧃",img:"https://images.unsplash.com/photo-1622597467836-f38240662c8b?w=200&fit=crop&auto=format",stock:54},
  {id:"m-enerji",n:"Enerji İçeceği",cat:"icecek",price:46,old:55,unit:"250 ml",emo:"⚡",img:"https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=200&fit=crop&auto=format",stock:40,tag:"Fırsat"},
  {id:"m-soguk-kahve",n:"Soğuk Kahve",cat:"icecek",price:52,unit:"250 ml",emo:"☕",img:"https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=200&fit=crop&auto=format",stock:28,tag:"Yeni"},
  {id:"m-ayran",n:"Ayran",cat:"icecek",price:18,unit:"300 ml",emo:"🥛",img:"https://images.unsplash.com/photo-1615486171448-4fb65b822d5b?w=200&fit=crop&auto=format",stock:64},
  {id:"m-kulah",n:"Külah Dondurma",cat:"dondurma",price:38,unit:"110 ml",emo:"🍦",img:"https://images.unsplash.com/photo-1559703248-dcaaec9fac92?w=200&fit=crop&auto=format",stock:35,tag:"Çok Satan"},
  {id:"m-cubuk-dond",n:"Çubuk Dondurma",cat:"dondurma",price:30,unit:"70 ml",emo:"🍡",img:"https://images.unsplash.com/photo-1563805042-7684c8a9e9ce?w=200&fit=crop&auto=format",stock:44},
  {id:"m-sandvic-dond",n:"Sandviç Dondurma",cat:"dondurma",price:34,unit:"90 ml",emo:"🍨",img:"https://images.unsplash.com/photo-1557142046-c704a3adf364?w=200&fit=crop&auto=format",stock:22},
  {id:"m-kutu-dond",n:"Kutu Dondurma",cat:"dondurma",price:120,old:140,unit:"900 ml",emo:"🍨",img:"https://images.unsplash.com/photo-1570197783617-0b535805f6e8?w=200&fit=crop&auto=format",stock:10,tag:"Fırsat"},
  {id:"m-sakiz",n:"Naneli Sakız",cat:"seker",price:12,unit:"14'lü",emo:"🍬",img:"https://images.unsplash.com/photo-1582050041567-9cfdd330d545?w=200&fit=crop&auto=format",stock:150},
  {id:"m-jelibon",n:"Jelibon",cat:"seker",price:26,unit:"80 g",emo:"🐻",img:"https://images.unsplash.com/photo-1582050041567-9cfdd330d545?w=200&fit=crop&auto=format",stock:58,tag:"Çok Satan"},
  {id:"m-lolipop",n:"Lolipop",cat:"seker",price:6,unit:"1 adet",emo:"🍭",img:"https://images.unsplash.com/photo-1575224300306-1b8da36134ec?w=200&fit=crop&auto=format",stock:200},
  {id:"m-cikolata-top",n:"Çikolatalı Toplar",cat:"seker",price:30,unit:"90 g",emo:"🟤",img:"https://images.unsplash.com/photo-1548907040-4d42b52125e0?w=200&fit=crop&auto=format",stock:40},
  {id:"m-nane-sekeri",n:"Nane Şekeri",cat:"seker",price:16,unit:"50 g",emo:"🌿",img:"https://images.unsplash.com/photo-1582050041567-9cfdd330d545?w=200&fit=crop&auto=format",stock:75},
  {id:"m-findik",n:"Kavrulmuş Fındık",cat:"kuruyemis",price:64,unit:"150 g",emo:"🌰",img:"https://images.unsplash.com/photo-1599599810694-f5b4b2f273db?w=200&fit=crop&auto=format",stock:30,tag:"Çok Satan"},
  {id:"m-leblebi",n:"Leblebi",cat:"kuruyemis",price:28,unit:"150 g",emo:"🟡",img:"https://images.unsplash.com/photo-1599599810694-f5b4b2f273db?w=200&fit=crop&auto=format",stock:52},
  {id:"m-cekirdek",n:"Çekirdek",cat:"kuruyemis",price:24,unit:"180 g",emo:"🌻",img:"https://images.unsplash.com/photo-1599599810694-f5b4b2f273db?w=200&fit=crop&auto=format",stock:88},
  {id:"m-karisik",n:"Karışık Kuruyemiş",cat:"kuruyemis",price:86,old:99,unit:"200 g",emo:"🥜",img:"https://images.unsplash.com/photo-1599599810694-f5b4b2f273db?w=200&fit=crop&auto=format",stock:16,tag:"Fırsat"},
  {id:"m-fistik",n:"Antep Fıstığı",cat:"kuruyemis",price:140,unit:"150 g",emo:"🟢",img:"https://images.unsplash.com/photo-1599599810694-f5b4b2f273db?w=200&fit=crop&auto=format",stock:9},
  {id:"m-badem",n:"Çiğ Badem",cat:"kuruyemis",price:78,unit:"150 g",emo:"🌰",img:"https://images.unsplash.com/photo-1599599810694-f5b4b2f273db?w=200&fit=crop&auto=format",stock:21},
  {id:"m-tost",n:"Hazır Tost",cat:"atistir",price:48,unit:"1 adet",emo:"🥪",img:"https://images.unsplash.com/photo-1528735602780-2ea56bed5217?w=200&fit=crop&auto=format",stock:18,tag:"Çok Satan"},
  {id:"m-pogaca",n:"Peynirli Poğaça",cat:"atistir",price:22,unit:"1 adet",emo:"🥐",img:"https://images.unsplash.com/photo-1509440159596-0249088772ff?w=200&fit=crop&auto=format",stock:26},
  {id:"m-simit",n:"Susamlı Simit",cat:"atistir",price:15,unit:"1 adet",emo:"🥯",img:"https://images.unsplash.com/photo-1509440159596-0249088772ff?w=200&fit=crop&auto=format",stock:30},
  {id:"m-borek",n:"Su Böreği (Dilim)",cat:"atistir",price:34,unit:"1 dilim",emo:"🥧",img:"https://images.unsplash.com/photo-1509440159596-0249088772ff?w=200&fit=crop&auto=format",stock:14},
  {id:"m-sandvic",n:"Hazır Sandviç",cat:"atistir",price:52,unit:"1 adet",emo:"🥖",img:"https://images.unsplash.com/photo-1528735602780-2ea56bed5217?w=200&fit=crop&auto=format",stock:12,tag:"Yeni"},
  {id:"m-cakmak",n:"Çakmak",cat:"acil",price:18,unit:"1 adet",emo:"🔥",img:"https://images.unsplash.com/photo-1616874535244-73aea5daadb9?w=200&fit=crop&auto=format",stock:80},
  {id:"m-pil",n:"Kalem Pil (4'lü)",cat:"acil",price:64,unit:"4'lü",emo:"🔋",img:"https://images.unsplash.com/photo-1584305590924-4f2445b2064c?w=200&fit=crop&auto=format",stock:34},
  {id:"m-mum",n:"Mum (Paket)",cat:"acil",price:30,unit:"6'lı",emo:"🕯️",img:"https://images.unsplash.com/photo-1602532454655-eb6520b22a0d?w=200&fit=crop&auto=format",stock:22},
  {id:"m-mendil",n:"Islak Mendil",cat:"acil",price:26,unit:"60'lı",emo:"🧻",img:"https://images.unsplash.com/photo-1584824388166-51c6838a5d3f?w=200&fit=crop&auto=format",stock:48},
